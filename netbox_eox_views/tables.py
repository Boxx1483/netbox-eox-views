...
class MissingDataDeviceTable(DeviceTable):
    eos_data = tables.Column(
        verbose_name="EOS Data",
        accessor="custom_field_data.eos_data"
    )
    eosr_data = tables.Column(
        verbose_name="EOSR Data",
        accessor="custom_field_data.eosr_data"
    )
    eosv_data = tables.Column(
        verbose_name="EOSV Data",
        accessor="custom_field_data.eosv_data"
    )
    ldos_data = tables.Column(
        verbose_name="LDOS Data",
        accessor="custom_field_data.ldos_data"
    )
    service_contract_end = tables.Column(
        verbose_name="Service Contract End",
    ...
    class Meta(DeviceTable.Meta):
        fields = DeviceTable.Meta.fields + ("eos_data", "eosr_data", "eosv_data", "ldos_data", "service_contract_end", "service_contract_status")